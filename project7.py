...
##    print "Average Common books: "+str(totaloutof/float(folds))
    ...
    print "FN: "+str(avgfn)
    print "TN: "+str(avgtn)
    print "Total: "+str(avgtp+avgfp+avgfn+avgtn)
    print "Precision: "+str((avgtp)/float(avgtp+avgfp))
    print "Recall: "+str((avgtp)/float(avgtp+avgfn))
    print
